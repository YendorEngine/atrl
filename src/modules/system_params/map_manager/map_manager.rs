...
impl<'a, 'w, 's> YendorFovProvider<VisionPassThroughData<'a>, GRID_SIZE> for MapManager<'w, 's> {
    fn is_opaque(&mut self, position: Position, pass_through_data: &mut VisionPassThroughData<'a>) -> bool {
