use crate::{components::PositionComponent, prelude::*, systems::functions::try_move, types::*};

pub const MOVE_TIME: u32 = SECONDS * 2;

#[derive(Debug, Clone)]
pub struct MovementAction(pub ChunkPosition);
